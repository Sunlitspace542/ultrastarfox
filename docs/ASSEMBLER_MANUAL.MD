...
If your macro uses labels or sublabels and you wish to invoke it more than once, attaching ``\@`` to the start or end of a label or sublabel will give it a unique name each time the macro is invoked.  
