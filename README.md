...
After building, a debug symbol map will be created at, and a bank space report at ``BANKS.LOG``.  
...
After building, a debug symbol map will be created at ``SYMBOLS.TXT``, and a bank space report at ``BANKS.LOG``.  
